...
function preload(){
  ...
  boyImg = loadImage("carro.png");
  cashImg = loadImage("dizel.png");
  diamondsImg = loadImage("alcool.png");
  jwelleryImg = loadImage("gazolina.png");
  swordImg = loadImage("rachadura.png");
...
function setup(){
  ...
  boy = createSprite(50,height-50 ,20,20);
...
// defina setvelocityEach como 0 para todos os grupos
  ...
  textSize(20);
  fill(255);
  text("Tanque: "+ treasureCollection,width-150,30);
  }
  if(gameState===END){
